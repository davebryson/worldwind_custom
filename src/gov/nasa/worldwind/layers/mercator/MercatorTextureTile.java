...
import gov.nasa.worldwind.util.Tile.TileFactory;

public class MercatorTextureTile extends GpuTextureTile
{
	...
	@Override
	public MercatorTextureTile[] subdivide(Level nextLevel, MemoryCache cache, TileFactory factory){
		return null;
	}
	@Override
